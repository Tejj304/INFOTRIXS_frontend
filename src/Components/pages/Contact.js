    ...
    <>
      <div className="container-xxl py-5">
            <div className="container">
                <h1 className="text-center text-black mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{fontWeight:'bold'}}>Contact For Any Query</h1>
                <div className="row g-4">
                        ...
                        <div className="row gy-4">
                            <div className="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <div className="d-flex align-items-center bg-light rounded p-4">
                                    <div className="bg-white border rounded d-flex flex-shrink-0 align-items-center justify-content-center me-3" style={{width: 35 , height: 35}}>
                    ...
                    <div className="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <iframe className="position-relative rounded w-100 h-100"
                            ...
                            frameborder="0" style={{lineHeight: 200, border:0}} allowfullscreen="" aria-hidden="false"
                            tabindex="0"></iframe>
                    </div>
